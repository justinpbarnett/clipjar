...
### Per-submission
- [ ] Upload `clipjar-chrome-1.1.1.zip`
...
### Per-submission
- [ ] Upload `clipjar-firefox-1.1.1.zip` as the extension package
- [ ] Upload source code: create a zip of the project root (excluding node_modules, dist-*, .git)
  ```bash
  zip -r clipjar-source-1.1.1.zip . \
...
- [ ] Tag the release in git: `git tag v1.1.1 && git push --tags`
